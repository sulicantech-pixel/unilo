...
import BottomNav from './components/BottomNav_Beautiful';
import HomePage from './pages/HomePage_BeautifulFinal';
import SearchPage from './pages/SearchPage';
import ListingPage from './pages/ListingPage';
import MapPage from './pages/MapPage_Searchable';
import CommunityPage from './pages/CommunityPage_Beautiful';
import WishlistPage from './pages/WishlistPage';
import LoginPage from './pages/LoginPage';
import RegisterPage from './pages/RegisterPage';
import BecomeHostPage from './pages/BecomeHostPage';
import NotFoundPage from './pages/NotFoundPage';
import QuickListModal from './components/QuickListModal_Beautiful';
