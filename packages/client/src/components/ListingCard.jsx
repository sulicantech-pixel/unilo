    ...
    >
      ...
      <div className="relative h-44 bg-white/5 overflow-hidden">
        ...
        <div className="absolute top-3 right-3">
          <span className={`badge text-[10px] ${listing.is_vacant ? 'bg-brand/90 text-navy' : 'bg-white/20 text-muted'}`}>
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-3">
          <div>
            ...
            <span className="text-muted text-xs ml-1">/ {listing.price_period === 'monthly' ? 'mo' : 'yr'}</span>
          </div>
